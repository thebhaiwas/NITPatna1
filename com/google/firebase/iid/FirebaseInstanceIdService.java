...
public class FirebaseInstanceIdService extends zzb {
    ...
    class C03021 extends BroadcastReceiver {
        ...
        C03021(FirebaseInstanceIdService firebaseInstanceIdService, int i) {
            this.baP = firebaseInstanceIdService;
            this.baO = i;
        }
        ...
        public void onReceive(Context context, Intent intent) {
            if (FirebaseInstanceIdService.zzel(context)) {
                ...
                context.sendBroadcast(FirebaseInstanceIdService.zzadr(this.baO));
            }
        }
    }
    ...
    private void zzads(int i) {
        ((AlarmManager) getSystemService(NotificationCompatApi21.CATEGORY_ALARM)).set(3, SystemClock.elapsedRealtime() + ((long) (i * ImageRequest.DEFAULT_IMAGE_TIMEOUT_MS)), PendingIntent.getBroadcast(this, 0, zzadr(i * 2), 268435456));
    }
