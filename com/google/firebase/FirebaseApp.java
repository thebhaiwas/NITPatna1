...
public class FirebaseApp {
    ...
    private static final List<String> aML;
    private static final List<String> aMM;
    private static final List<String> aMN;
    private static final Set<String> aMO;
    static final Map<String, FirebaseApp> abO;
    ...
    private final List<zza> aMS;
    private final List<zzb> aMT;
    private final List<Object> aMU;
    protected zzalt aMV;
    private final String mName;
    private final Context zzaqj;

    public interface zza {
        void zzb(@NonNull zzalt com_google_android_gms_internal_zzalt, @Nullable FirebaseUser firebaseUser);
    }
    ...
    static {
        aML = Arrays.asList(new String[]{"com.google.firebase.auth.FirebaseAuth", "com.google.firebase.iid.FirebaseInstanceId"});
        aMM = Collections.singletonList("com.google.firebase.crash.FirebaseCrash");
        aMN = Arrays.asList(new String[]{"com.google.android.gms.measurement.AppMeasurement"});
        aMO = Collections.emptySet();
        zzamp = new Object();
        abO = new ArrayMap();
    }
