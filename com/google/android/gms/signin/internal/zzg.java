...
public class zzg extends zzk<zze> implements zzvx {
    ...
    public zzg(Context context, Looper looper, boolean z, com.google.android.gms.common.internal.zzg com_google_android_gms_common_internal_zzg, Bundle bundle, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        this.auw = bundle;
        this.yb = com_google_android_gms_common_internal_zzg.zzasm();
    }

    public zzg(Context context, Looper looper, boolean z, com.google.android.gms.common.internal.zzg com_google_android_gms_common_internal_zzg, zzvy com_google_android_gms_internal_zzvy, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public static Bundle zza(com.google.android.gms.common.internal.zzg com_google_android_gms_common_internal_zzg) {
        zzvy zzasl = com_google_android_gms_common_internal_zzg.zzasl();
        Integer zzasm = com_google_android_gms_common_internal_zzg.zzasm();
    ...
    public void zza(zzq com_google_android_gms_common_internal_zzq, boolean z) {
        try {
            ((zze) zzarw()).zza(com_google_android_gms_common_internal_zzq, this.yb.intValue(), z);
    ...
    public void zza(zzd com_google_android_gms_signin_internal_zzd) {
        ...
        try {
            ((zze) zzarw()).zza(new SignInRequest(zzbzt()), com_google_android_gms_signin_internal_zzd);
        } catch (Throwable e) {
