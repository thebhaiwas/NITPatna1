...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzaus() {
        ...
        String join = zzauz() == null ? BuildConfig.FLAVOR : TextUtils.join(",", zzauz());
        String valueOf5 = String.valueOf("\t");
        int zzava = zzava();
        String valueOf6 = String.valueOf("\t");
        String zzauw = zzauw() == null ? BuildConfig.FLAVOR : zzauw();
        String valueOf7 = String.valueOf("\t");
        String zzavb = zzavb() == null ? BuildConfig.FLAVOR : zzavb();
        String valueOf8 = String.valueOf("\t");
        float zzavc = zzavc();
        String valueOf9 = String.valueOf("\t");
        String zzaux = zzaux() == null ? BuildConfig.FLAVOR : zzaux();
