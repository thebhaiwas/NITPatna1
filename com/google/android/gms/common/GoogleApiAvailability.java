...
public class GoogleApiAvailability extends zzc {
    ...
    private static final GoogleApiAvailability qU;

    static {
        qU = new GoogleApiAvailability();
    ...
    public Dialog zza(Activity activity, OnCancelListener onCancelListener) {
        ...
        builder.setMessage(activity.getResources().getString(C0219R.string.common_google_play_services_updating_text, new Object[]{zzbv}));
        builder.setTitle(C0219R.string.common_google_play_services_updating_title);
    ...
    @Nullable
    public zzqj zza(Context context, zza com_google_android_gms_internal_zzqj_zza) {
        IntentFilter intentFilter = new IntentFilter("android.intent.action.PACKAGE_ADDED");
        intentFilter.addDataScheme("package");
        BroadcastReceiver com_google_android_gms_internal_zzqj = new zzqj(com_google_android_gms_internal_zzqj_zza);
        context.registerReceiver(com_google_android_gms_internal_zzqj, intentFilter);
        com_google_android_gms_internal_zzqj.setContext(context);
        if (zzm(context, GOOGLE_PLAY_SERVICES_PACKAGE)) {
            return com_google_android_gms_internal_zzqj;
        }
        com_google_android_gms_internal_zzqj_zza.zzaor();
        com_google_android_gms_internal_zzqj.unregister();
        return null;
    }
    ...
    public boolean zza(Activity activity, @NonNull zzqp com_google_android_gms_internal_zzqp, int i, int i2, OnCancelListener onCancelListener) {
        Dialog zza = GooglePlayServicesUtil.zza(i, activity, com.google.android.gms.common.internal.zzi.zza(com_google_android_gms_internal_zzqp, zza((Context) activity, i, "d"), i2), onCancelListener);
        if (zza == null) {
            return false;
        }
