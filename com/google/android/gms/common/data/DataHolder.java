...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    class C04251 extends zza {
        C04251(String[] strArr, String str) {
            super(str, null);
        }
    ...
    static {
        CREATOR = new zze();
        vW = new C04251(new String[0], null);
    }
    ...
    private DataHolder(zza com_google_android_gms_common_data_DataHolder_zza, int i, Bundle bundle) {
        this(com_google_android_gms_common_data_DataHolder_zza.vO, zza(com_google_android_gms_common_data_DataHolder_zza, -1), i, bundle);
    }
    ...
    private static CursorWindow[] zza(zza com_google_android_gms_common_data_DataHolder_zza, int i) {
        int i2 = 0;
        if (com_google_android_gms_common_data_DataHolder_zza.vO.length == 0) {
            return new CursorWindow[0];
        }
        List zzb = (i < 0 || i >= com_google_android_gms_common_data_DataHolder_zza.vX.size()) ? com_google_android_gms_common_data_DataHolder_zza.vX : com_google_android_gms_common_data_DataHolder_zza.vX.subList(0, i);
        int size = zzb.size();
        CursorWindow cursorWindow = new CursorWindow(false);
        ArrayList arrayList = new ArrayList();
        arrayList.add(cursorWindow);
        cursorWindow.setNumColumns(com_google_android_gms_common_data_DataHolder_zza.vO.length);
        int i3 = 0;
        int i4 = 0;
        while (i3 < size) {
            try {
                ...
                boolean z = true;
                for (int i7 = 0; i7 < com_google_android_gms_common_data_DataHolder_zza.vO.length && z; i7++) {
                    String str = com_google_android_gms_common_data_DataHolder_zza.vO[i7];
                ...
                if (z) {
                    ...
                    cursorWindow3.setNumColumns(com_google_android_gms_common_data_DataHolder_zza.vO.length);
