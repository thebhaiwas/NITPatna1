...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public static final ConnectionResult qR;
    ...
    static {
        qR = new ConnectionResult(SUCCESS);
        CREATOR = new zzb();
    }
    ...
    public int hashCode() {
        ...
        objArr[SUCCESS] = Integer.valueOf(this.ob);
        objArr[SERVICE_MISSING] = this.mPendingIntent;
        objArr[SERVICE_VERSION_UPDATE_REQUIRED] = this.qS;
