...
public abstract class zzc<O extends ApiOptions> {
    ...
    private <TResult, A extends zzb> Task<TResult> zza(int i, @NonNull zzrb<A, TResult> com_google_android_gms_internal_zzrb_A__TResult) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.rH.zza(this, i, com_google_android_gms_internal_zzrb_A__TResult, taskCompletionSource);
    ...
    public void release() {
        ...
        if (!this.rJ.getAndSet(true)) {
            this.rE.release();
            zzqh com_google_android_gms_internal_zzqh = this.rH;
            int i = this.mId;
            if (this.rK.get() <= 0) {
                z = false;
            }
            com_google_android_gms_internal_zzqh.zzd(i, z);
        }
    }
    ...
    public <TResult, A extends zzb> Task<TResult> zza(zzrb<A, TResult> com_google_android_gms_internal_zzrb_A__TResult) {
        return zza(0, (zzrb) com_google_android_gms_internal_zzrb_A__TResult);
    }
    ...
    public <TResult, A extends zzb> Task<TResult> zzb(zzrb<A, TResult> com_google_android_gms_internal_zzrb_A__TResult) {
        return zza(1, (zzrb) com_google_android_gms_internal_zzrb_A__TResult);
    }
}
