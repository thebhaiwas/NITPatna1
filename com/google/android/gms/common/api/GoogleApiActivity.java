...
public class GoogleApiActivity extends Activity implements OnCancelListener {
    ...
    private void zza(int i, zzqh com_google_android_gms_internal_zzqh) {
        switch (i) {
            case GridLayoutManager.DEFAULT_SPAN_COUNT /*-1*/:
                com_google_android_gms_internal_zzqh.zzaol();
            case ConnectionResult.SUCCESS /*0*/:
                com_google_android_gms_internal_zzqh.zza(new ConnectionResult(13, null), getIntent().getIntExtra("failing_client_id", -1));
            default:
        }
    }
