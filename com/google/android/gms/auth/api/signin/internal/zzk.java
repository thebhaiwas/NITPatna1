...
public class zzk {
    private static final Lock eu;
    private static zzk ev;
    private final Lock ew;
    private final SharedPreferences ex;

    static {
        eu = new ReentrantLock();
    }

    zzk(Context context) {
        this.ew = new ReentrantLock();
    ...
    public static zzk zzbc(Context context) {
        ...
        try {
            ...
            zzk com_google_android_gms_auth_api_signin_internal_zzk = ev;
