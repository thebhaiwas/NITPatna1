...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional {
    ...
    private static Comparator<Scope> dO;
    public static final Scope dP;
    public static final Scope dQ;
    public static final Scope dR;
    private Account aP;
    ...
    class C02231 implements Comparator<Scope> {
        C02231() {
        }
    ...
    public static final class Builder {
        ...
        public GoogleSignInOptions build() {
            ...
            return new GoogleSignInOptions(this.aP, this.dT, this.dU, this.dV, this.dW, this.dX, null);
        }
