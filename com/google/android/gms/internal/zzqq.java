...
public final class zzqq extends Fragment implements zzqp {
    private static WeakHashMap<Activity, WeakReference<zzqq>> vb;
    ...
    class C02481 implements Runnable {
        ...
        C02481(zzqq com_google_android_gms_internal_zzqq, zzqo com_google_android_gms_internal_zzqo, String str) {
            this.vf = com_google_android_gms_internal_zzqq;
        ...
        public void run() {
            if (this.vf.zzblz >= 1) {
                this.ve.onCreate(this.vf.vd != null ? this.vf.vd.getBundle(this.zzap) : null);
            }
            if (this.vf.zzblz >= 2) {
                this.ve.onStart();
            }
    ...
    private void zzb(String str, @NonNull zzqo com_google_android_gms_internal_zzqo) {
        if (this.zzblz > 0) {
            new Handler(Looper.getMainLooper()).post(new C02481(this, com_google_android_gms_internal_zzqo, str));
        }
    }
