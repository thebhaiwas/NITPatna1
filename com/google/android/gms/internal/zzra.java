...
public final class zzra extends Fragment implements zzqp {
    private static WeakHashMap<FragmentActivity, WeakReference<zzra>> vb;
    private Map<String, zzqo> vc;
    private Bundle vd;
    private int zzblz;

    /* renamed from: com.google.android.gms.internal.zzra.1 */
    class C02491 implements Runnable {
        final /* synthetic */ zzqo ve;
        final /* synthetic */ zzra vj;
        final /* synthetic */ String zzap;

        C02491(zzra com_google_android_gms_internal_zzra, zzqo com_google_android_gms_internal_zzqo, String str) {
            this.vj = com_google_android_gms_internal_zzra;
            this.ve = com_google_android_gms_internal_zzqo;
            this.zzap = str;
        }

        public void run() {
            if (this.vj.zzblz >= 1) {
                this.ve.onCreate(this.vj.vd != null ? this.vj.vd.getBundle(this.zzap) : null);
            }
            if (this.vj.zzblz >= 2) {
                this.ve.onStart();
            }
    ...
    private void zzb(String str, @NonNull zzqo com_google_android_gms_internal_zzqo) {
        if (this.zzblz > 0) {
            new Handler(Looper.getMainLooper()).post(new C02491(this, com_google_android_gms_internal_zzqo, str));
        }
    }
