...
public final class zzrf extends Drawable implements Callback {
    ...
    private static final class zza extends Drawable {
        private static final zza wR;
        private static final zza wS;
    ...
    static final class zzb extends ConstantState {
        ...
        zzb(zzb com_google_android_gms_internal_zzrf_zzb) {
            if (com_google_android_gms_internal_zzrf_zzb != null) {
                this.wT = com_google_android_gms_internal_zzrf_zzb.wT;
                this.wU = com_google_android_gms_internal_zzrf_zzb.wU;
            }
        }
    ...
    public zzrf(Drawable drawable, Drawable drawable2) {
        ...
        zzb com_google_android_gms_internal_zzrf_zzb = this.wK;
        com_google_android_gms_internal_zzrf_zzb.wU |= drawable.getChangingConfigurations();
        if (drawable2 == null) {
            drawable2 = zza.wR;
        }
        this.wM = drawable2;
        drawable2.setCallback(this);
        com_google_android_gms_internal_zzrf_zzb = this.wK;
        com_google_android_gms_internal_zzrf_zzb.wU |= drawable2.getChangingConfigurations();
    }

    zzrf(zzb com_google_android_gms_internal_zzrf_zzb) {
        this.wE = 0;
        this.wG = MotionEventCompat.ACTION_MASK;
        this.wI = 0;
        this.wy = true;
        this.wK = new zzb(com_google_android_gms_internal_zzrf_zzb);
    }
        ...
        switch (this.wE) {
            ...
            case ConnectionResult.SERVICE_VERSION_UPDATE_REQUIRED /*2*/:
                if (this.zzczk >= 0) {
                    ...
                    this.wI = (int) ((Math.min(uptimeMillis, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) * ((float) (this.wF + 0))) + 0.0f);
                    break;
                }
                break;
        }
