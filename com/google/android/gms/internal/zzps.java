...
public abstract class zzps extends zzqo implements OnCancelListener {
    ...
    private class zza implements Runnable {
        ...
        /* renamed from: com.google.android.gms.internal.zzps.zza.1 */
        class C04861 extends com.google.android.gms.internal.zzqj.zza {
            final /* synthetic */ Dialog sG;
            final /* synthetic */ zza sH;

            C04861(zza com_google_android_gms_internal_zzps_zza, Dialog dialog) {
                this.sH = com_google_android_gms_internal_zzps_zza;
                this.sG = dialog;
            }
        ...
        private zza(zzps com_google_android_gms_internal_zzps) {
            this.sF = com_google_android_gms_internal_zzps;
        }
        ...
        public void run() {
            ...
            if (this.sF.sC.hasResolution()) {
                ...
                this.sF.rX.zza(this.sF.getActivity().getApplicationContext(), new C04861(this, this.sF.rX.zza(this.sF.getActivity(), this.sF)));
            } else {
    ...
    protected zzps(zzqp com_google_android_gms_internal_zzqp) {
        this(com_google_android_gms_internal_zzqp, GoogleApiAvailability.getInstance());
    }

    zzps(zzqp com_google_android_gms_internal_zzqp, GoogleApiAvailability googleApiAvailability) {
