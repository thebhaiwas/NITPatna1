...
public final class zzaov {
    ...
    public static class zza extends IOException {
        zza(int i, int i2) {
            super(new StringBuilder(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall).append("CodedOutputStream was writing to a flat byte array and ran out of space (pos ").append(i).append(" limit ").append(i2).append(").").toString());
        }
    }
    ...
    public void zzaes(int i) throws IOException {
        while ((i & -128) != 0) {
            zzaeq((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i >>>= 7;
        }
        zzaeq(i);
    }
    ...
    public void zzcz(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzaeq((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            j >>>= 7;
        }
        zzaeq((int) j);
    }
