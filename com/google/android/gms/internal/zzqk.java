...
public final class zzqk {
    ...
    zzqk(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C0219R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
        ...
        this.uU = com_google_android_gms_common_internal_zzai.getString("firebase_database_url");
        this.uW = com_google_android_gms_common_internal_zzai.getString("google_storage_bucket");
        this.uV = com_google_android_gms_common_internal_zzai.getString("gcm_defaultSenderId");
        this.uS = com_google_android_gms_common_internal_zzai.getString("google_api_key");
    ...
    private static zzqk zzgy(String str) {
        zzqk com_google_android_gms_internal_zzqk;
        synchronized (zzamp) {
            if (uR == null) {
                throw new IllegalStateException(new StringBuilder(String.valueOf(str).length() + 34).append("Initialize must be called before ").append(str).append(".").toString());
            }
            com_google_android_gms_internal_zzqk = uR;
        }
        return com_google_android_gms_internal_zzqk;
    }
