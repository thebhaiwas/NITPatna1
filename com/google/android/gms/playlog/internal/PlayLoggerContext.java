...
public class PlayLoggerContext extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        stringBuilder.append("packageVersionCode=").append(this.ash).append(',');
        stringBuilder.append("logSource=").append(this.asi).append(',');
        stringBuilder.append("logSourceName=").append(this.asm).append(',');
        stringBuilder.append("uploadAccount=").append(this.asj).append(',');
        stringBuilder.append("loggingId=").append(this.ask).append(',');
        stringBuilder.append("logAndroidId=").append(this.asl).append(',');
        stringBuilder.append("isAnonymous=").append(this.asn).append(',');
