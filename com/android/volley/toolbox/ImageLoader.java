...
public class ImageLoader {
    ...
    class C04222 implements Listener<Bitmap> {
    ...
    class C04233 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C05771(errorImageResId, view, defaultImageResId);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, String cacheKey) {
        return new ImageRequest(requestUrl, new C04222(cacheKey), maxWidth, maxHeight, scaleType, Config.RGB_565, new C04233(cacheKey));
    }
