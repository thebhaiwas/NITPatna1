...
final class RealCall implements Call {
    ...
    void enqueue(Callback responseCallback, boolean forWebSocket) {
        ...
        this.client.dispatcher().enqueue(new AsyncCall(responseCallback, forWebSocket, null));
    }
    ...
    private String toLoggableString() {
        return (this.canceled ? "canceled call" : NotificationCompatApi21.CATEGORY_CALL) + " to " + this.originalRequest.url().resolve("/...");
    }
