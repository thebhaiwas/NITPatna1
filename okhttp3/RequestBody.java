...
public abstract class RequestBody {
    ...
    static class C05201 extends RequestBody {
        final /* synthetic */ ByteString val$content;
        final /* synthetic */ MediaType val$contentType;

        C05201(MediaType mediaType, ByteString byteString) {
    ...
    static class C05212 extends RequestBody {
        final /* synthetic */ int val$byteCount;
        final /* synthetic */ byte[] val$content;
        final /* synthetic */ MediaType val$contentType;
        final /* synthetic */ int val$offset;

        C05212(MediaType mediaType, int i, byte[] bArr, int i2) {
            this.val$contentType = mediaType;
    ...
    static class C05223 extends RequestBody {
        final /* synthetic */ MediaType val$contentType;
        final /* synthetic */ File val$file;

        C05223(MediaType mediaType, File file) {
            this.val$contentType = mediaType;
            this.val$file = file;
        }
    ...
    public static RequestBody create(MediaType contentType, ByteString content) {
        return new C05201(contentType, content);
    }
    ...
    public static RequestBody create(MediaType contentType, byte[] content, int offset, int byteCount) {
        ...
        return new C05212(contentType, byteCount, content, offset);
    }

    public static RequestBody create(MediaType contentType, File file) {
        if (file != null) {
            return new C05223(contentType, file);
        }
        throw new NullPointerException("content == null");
    }
}
