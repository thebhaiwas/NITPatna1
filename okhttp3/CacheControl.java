...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        public Builder maxAge(int maxAge, TimeUnit timeUnit) {
            ...
            this.maxAgeSeconds = maxAgeSecondsLong > 2147483647L ? ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) maxAgeSecondsLong;
            return this;
        }
        ...
        public Builder maxStale(int maxStale, TimeUnit timeUnit) {
            ...
            this.maxStaleSeconds = maxStaleSecondsLong > 2147483647L ? ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) maxStaleSecondsLong;
            return this;
        }
        ...
        public Builder minFresh(int minFresh, TimeUnit timeUnit) {
            ...
            this.minFreshSeconds = minFreshSecondsLong > 2147483647L ? ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) minFreshSecondsLong;
            return this;
        }
    ...
    static {
        ...
        FORCE_CACHE = new Builder().onlyIfCached().maxStale(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, TimeUnit.SECONDS).build();
    }
