...
public final class Cache implements Closeable, Flushable {
    ...
    class C03072 implements Iterator<String> {
        boolean canRemove;
        final Iterator<Snapshot> delegate;
        String nextUrl;

        C03072() throws IOException {
    ...
    class C05161 implements InternalCache {
        C05161() {
        }
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        class C05891 extends ForwardingSink {
            final /* synthetic */ Editor val$editor;
            final /* synthetic */ Cache val$this$0;

            C05891(Sink x0, Cache cache, Editor editor) {
        ...
        public CacheRequestImpl(Editor editor) throws IOException {
            ...
            this.body = new C05891(this.cacheOut, Cache.this, editor);
        }
    ...
    private static class CacheResponseBody extends ResponseBody {
        ...
        class C05901 extends ForwardingSource {
            final /* synthetic */ Snapshot val$snapshot;

            C05901(Source x0, Snapshot snapshot) {
        ...
        public CacheResponseBody(Snapshot snapshot, String contentType, String contentLength) {
            ...
            this.bodySource = Okio.buffer(new C05901(snapshot.getSource(Cache.ENTRY_BODY), snapshot));
        }
