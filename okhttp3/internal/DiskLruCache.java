...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    /* renamed from: okhttp3.internal.DiskLruCache.1 */
    ...
    /* renamed from: okhttp3.internal.DiskLruCache.3 */
    class C03203 implements Iterator<Snapshot> {
    ...
    public final class Editor {
        ...
        /* renamed from: okhttp3.internal.DiskLruCache.Editor.1 */
        class C05961 extends FaultHidingSink {
            C05961(Sink delegate) {
                super(delegate);
            }
        ...
        public Sink newSink(int index) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    c05961 = new C05961(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index]));
                } catch (FileNotFoundException e) {
                    c05961 = DiskLruCache.NULL_SINK;
                }
            }
            return c05961;
        }
    ...
    /* renamed from: okhttp3.internal.DiskLruCache.4 */
    static class C05244 implements Sink {
        C05244() {
        }
    ...
    /* renamed from: okhttp3.internal.DiskLruCache.2 */
    class C05952 extends FaultHidingSink {
        static final /* synthetic */ boolean $assertionsDisabled;
    ...
    DiskLruCache(FileSystem fileSystem, File directory, int appVersion, int valueCount, long maxSize, Executor executor) {
        ...
        this.cleanupRunnable = new C03191();
    ...
    private void readJournal() throws IOException {
        ...
        try {
            ...
            if (MAGIC.equals(magic) && VERSION_1.equals(version) && Integer.toString(this.appVersion).equals(appVersionString) && Integer.toString(this.valueCount).equals(valueCountString) && BuildConfig.FLAVOR.equals(blank)) {
                lineCount = 0;
                while (true) {
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new C05952(this.fileSystem.appendingSink(this.journalFile)));
    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized void completeEdit(okhttp3.internal.DiskLruCache.Editor r13, boolean r14) throws java.io.IOException {
        /*
        r12 = this;
        monitor-enter(r12);
    ...
    L_0x00fb:
        ...
        goto L_0x00df;
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.DiskLruCache.completeEdit(okhttp3.internal.DiskLruCache$Editor, boolean):void");
    }
