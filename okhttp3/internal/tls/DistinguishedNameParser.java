...
final class DistinguishedNameParser {
    ...
    private char getEscaped() {
        ...
        switch (this.chars[this.pos]) {
            ...
            case C0337R.styleable.AppCompatTheme_listDividerAlertDialog /*44*/:
            case C0337R.styleable.AppCompatTheme_toolbarNavigationButtonStyle /*59*/:
            case C0337R.styleable.AppCompatTheme_popupMenuStyle /*60*/:
            case C0337R.styleable.AppCompatTheme_popupWindowStyle /*61*/:
            case C0337R.styleable.AppCompatTheme_editTextColor /*62*/:
            case C0337R.styleable.AppCompatTheme_alertDialogButtonGroupStyle /*92*/:
            case C0337R.styleable.AppCompatTheme_textColorAlertDialogListItem /*95*/:
    ...
    private int getByte(int position) {
        ...
        if (b1 >= 48 && b1 <= 57) {
            b1 -= 48;
        } else if (b1 >= 97 && b1 <= C0337R.styleable.AppCompatTheme_checkboxStyle) {
            b1 -= 87;
        } else if (b1 < 65 || b1 > 70) {
            throw new IllegalStateException("Malformed DN: " + this.dn);
        } else {
        ...
        if (b2 >= 48 && b2 <= 57) {
            b2 -= 48;
        } else if (b2 >= 97 && b2 <= C0337R.styleable.AppCompatTheme_checkboxStyle) {
            b2 -= 87;
        } else if (b2 < 65 || b2 > 70) {
            throw new IllegalStateException("Malformed DN: " + this.dn);
        } else {
