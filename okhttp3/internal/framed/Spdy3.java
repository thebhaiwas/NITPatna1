...
public final class Spdy3 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        public boolean nextFrame(Handler handler) throws IOException {
            ...
            try {
                ...
                if ((LinearLayoutManager.INVALID_OFFSET & w1) != 0) {
                    control = true;
                } else {
                    control = false;
                }
    ...
    static final class Writer implements FrameWriter {
        ...
        public synchronized void synStream(boolean outFinished, boolean inFinished, int streamId, int associatedStreamId, List<Header> headerBlock) throws IOException {
            ...
            this.sink.writeInt(((flags & MotionEventCompat.ACTION_MASK) << 24) | (ViewCompat.MEASURED_SIZE_MASK & length));
        ...
        public synchronized void headers(int streamId, List<Header> headerBlock) throws IOException {
            ...
            this.sink.writeInt((ViewCompat.MEASURED_SIZE_MASK & length) | Spdy3.TYPE_DATA);
            this.sink.writeInt(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED & streamId);
            this.sink.writeAll(this.headerBlockBuffer);
        }
        ...
        void sendDataFrame(int streamId, int flags, Buffer buffer, int byteCount) throws IOException {
            if (this.closed) {
                ...
                this.sink.writeInt(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED & streamId);
                this.sink.writeInt(((flags & MotionEventCompat.ACTION_MASK) << 24) | (ViewCompat.MEASURED_SIZE_MASK & byteCount));
                if (byteCount > 0) {
        ...
        public synchronized void settings(Settings settings) throws IOException {
            ...
            this.sink.writeInt((length & ViewCompat.MEASURED_SIZE_MASK) | Spdy3.TYPE_DATA);
            this.sink.writeInt(size);
            for (int i = Spdy3.TYPE_DATA; i <= 10; i += Spdy3.TYPE_SYN_STREAM) {
                if (settings.isSet(i)) {
                    this.sink.writeInt(((settings.flags(i) & MotionEventCompat.ACTION_MASK) << 24) | (i & ViewCompat.MEASURED_SIZE_MASK));
