    ...
    public static class PathDataNode {
        ...
        public void interpolatePathDataNode(PathDataNode nodeFrom, PathDataNode nodeTo, float fraction) {
            for (int i = 0; i < nodeFrom.params.length; i++) {
                this.params[i] = (nodeFrom.params[i] * (DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - fraction)) + (nodeTo.params[i] * fraction);
            }
        }
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case C0337R.styleable.AppCompatTheme_textAppearanceSearchResultTitle /*65*/:
                case C0337R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle /*97*/:
                    incr = 7;
                    break;
                case C0337R.styleable.AppCompatTheme_textColorSearchUrl /*67*/:
                case C0337R.styleable.AppCompatTheme_autoCompleteTextViewStyle /*99*/:
                    incr = 6;
                    break;
                case C0337R.styleable.AppCompatTheme_listPreferredItemPaddingLeft /*72*/:
                case C0337R.styleable.AppCompatTheme_colorControlActivated /*86*/:
                case C0337R.styleable.AppCompatTheme_editTextStyle /*104*/:
                case 'v':
                    incr = 1;
                    break;
                case C0337R.styleable.AppCompatTheme_textAppearanceListItem /*76*/:
                case C0337R.styleable.AppCompatTheme_textAppearanceListItemSmall /*77*/:
                case C0337R.styleable.AppCompatTheme_colorAccent /*84*/:
                case C0337R.styleable.AppCompatTheme_ratingBarStyleSmall /*108*/:
                case C0337R.styleable.AppCompatTheme_seekBarStyle /*109*/:
                case 't':
                    incr = 2;
                    break;
                case C0337R.styleable.AppCompatTheme_listChoiceBackgroundIndicator /*81*/:
                case C0337R.styleable.AppCompatTheme_colorPrimaryDark /*83*/:
                case 'q':
                case 's':
                    incr = 4;
                    break;
                ...
                switch (cmd) {
                    ...
                    case C0337R.styleable.AppCompatTheme_colorPrimaryDark /*83*/:
                        ...
                        if (previousCmd == 'c' || previousCmd == 's' || previousCmd == 'C' || previousCmd == 'S') {
                            reflectiveCtrlPointX = (ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT * currentX) - ctrlPointX;
                            reflectiveCtrlPointY = (ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT * currentY) - ctrlPointY;
                        }
