...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VGroup {
        ...
        public VGroup(VGroup copy, ArrayMap<String, Object> targetsMap) {
            ...
            this.mPivotX = 0.0f;
            this.mPivotY = 0.0f;
            this.mScaleX = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
            this.mScaleY = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (!(fullPath.mTrimPathStart == 0.0f && fullPath.mTrimPathEnd == DefaultRetryPolicy.DEFAULT_BACKOFF_MULT)) {
                    float start = (fullPath.mTrimPathStart + fullPath.mTrimPathOffset) % DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
                    float end = (fullPath.mTrimPathEnd + fullPath.mTrimPathOffset) % DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
        ...
        private float getMatrixScale(Matrix groupStackedMatrix) {
            float[] unitVectors = new float[]{0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f};
    ...
    private static class VFullPath extends VPath {
        ...
        public VFullPath() {
            ...
            this.mStrokeAlpha = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
            this.mFillAlpha = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
            this.mTrimPathStart = 0.0f;
            this.mTrimPathEnd = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
