...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01913 implements Runnable {
        C01913() {
        }
    ...
    class C01924 implements OnFocusChangeListener {
        C01924() {
        }
    ...
    class C01935 implements OnLayoutChangeListener {
        C01935() {
        }
    ...
    class C01946 implements OnGlobalLayoutListener {
        C01946() {
        }
    ...
    class C01957 implements OnClickListener {
        C01957() {
        }
    ...
    class C01968 implements OnKeyListener {
        C01968() {
        }
    ...
    class C01979 implements OnEditorActionListener {
        C01979() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0158R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0158R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C01891();
        this.mUpdateDrawableStateRunnable = new C01902();
        this.mReleaseCursorRunnable = new C01913();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01957();
        this.mTextKeyListener = new C01968();
        this.mOnEditorActionListener = new C01979();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0158R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0158R.styleable.SearchView_layout, C0158R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0158R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0158R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0158R.id.search_plate);
        this.mSubmitArea = findViewById(C0158R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0158R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0158R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0158R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0158R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0158R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0158R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0158R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0158R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0158R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0158R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0158R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0158R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0158R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0158R.styleable.SearchView_suggestionRowLayout, C0158R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0158R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01924());
        setIconifiedByDefault(a.getBoolean(C0158R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0158R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0158R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0158R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0158R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0158R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0158R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01935());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01946());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0158R.dimen.abc_search_view_preferred_width);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0158R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0158R.dimen.abc_dropdownitem_text_padding_left) : 0;
