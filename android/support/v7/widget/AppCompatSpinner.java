...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C04081 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C04081(View x0, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C01751 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C01751(AppCompatSpinner appCompatSpinner) {
        ...
        class C01762 implements OnGlobalLayoutListener {
            C01762() {
            }
        ...
        class C01773 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C01773(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C01751(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C01762();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C01773(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0158R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0158R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0158R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(C0158R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0158R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                this.mDropDownWidth = pa.getLayoutDimension(C0158R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0158R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0158R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C04081(this, popup);
            }
        }
        CharSequence[] entries = a.getTextArray(C0158R.styleable.Spinner_android_entries);
        if (entries != null) {
            SpinnerAdapter adapter = new ArrayAdapter(context, C0158R.layout.support_simple_spinner_dropdown_item, entries);
            adapter.setDropDownViewResource(C0158R.layout.support_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
        a.recycle();
        this.mPopupSet = true;
