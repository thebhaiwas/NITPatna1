...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C05671 extends ViewPropertyAnimatorListenerAdapter {
        C05671() {
        }
    ...
    static {
        ATTRS = new int[]{C0158R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C05671();
        this.mRemoveActionBarHideOffset = new C01642();
        this.mAddActionBarHideOffset = new C01653();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0158R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0158R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0158R.id.action_bar));
        }
    }
