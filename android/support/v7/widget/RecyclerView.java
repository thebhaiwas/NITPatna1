...
import android.support.v7.recyclerview.C0159R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static class C01863 implements Interpolator {
        C01863() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0159R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0159R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0159R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0159R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0159R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01871 implements Creator<SavedState> {
            C01871() {
            }
    ...
    private class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            if (velocity > 0) {
                ...
                duration = (int) (((((float) absDx) / ((float) containerSize)) + DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) * 300.0f);
            }
    ...
    class C04134 implements ProcessCallback {
        C04134() {
        }
    ...
    class C04145 implements Callback {
        C04145() {
        }
    ...
    class C04156 implements Callback {
        C04156() {
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C01863();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01841();
        ...
        this.mItemAnimatorRunner = new C01852();
        this.mViewInfoProcessCallback = new C04134();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0159R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0159R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04145());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04156());
    }
