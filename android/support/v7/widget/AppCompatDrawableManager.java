...
public final class AppCompatDrawableManager {
    ...
    static {
        ...
        COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0158R.drawable.abc_textfield_search_default_mtrl_alpha, C0158R.drawable.abc_textfield_default_mtrl_alpha, C0158R.drawable.abc_ab_share_pack_mtrl_alpha};
        TINT_COLOR_CONTROL_NORMAL = new int[]{C0158R.drawable.abc_ic_ab_back_mtrl_am_alpha, C0158R.drawable.abc_ic_go_search_api_mtrl_alpha, C0158R.drawable.abc_ic_search_api_mtrl_alpha, C0158R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0158R.drawable.abc_ic_clear_mtrl_alpha, C0158R.drawable.abc_ic_menu_share_mtrl_alpha, C0158R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0158R.drawable.abc_ic_menu_cut_mtrl_alpha, C0158R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0158R.drawable.abc_ic_menu_paste_mtrl_am_alpha, C0158R.drawable.abc_ic_menu_moreoverflow_mtrl_alpha, C0158R.drawable.abc_ic_voice_search_api_mtrl_alpha};
        COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0158R.drawable.abc_textfield_activated_mtrl_alpha, C0158R.drawable.abc_textfield_search_activated_mtrl_alpha, C0158R.drawable.abc_cab_background_top_mtrl_alpha, C0158R.drawable.abc_text_cursor_material};
        COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0158R.drawable.abc_popup_background_mtrl_mult, C0158R.drawable.abc_cab_background_internal_bg, C0158R.drawable.abc_menu_hardkey_panel_mtrl_mult};
        TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0158R.drawable.abc_edit_text_material, C0158R.drawable.abc_tab_indicator_material, C0158R.drawable.abc_textfield_search_material, C0158R.drawable.abc_spinner_mtrl_am_alpha, C0158R.drawable.abc_spinner_textfield_background_material, C0158R.drawable.abc_ratingbar_full_material, C0158R.drawable.abc_switch_track_mtrl_alpha, C0158R.drawable.abc_switch_thumb_material, C0158R.drawable.abc_btn_default_mtrl_shape, C0158R.drawable.abc_btn_borderless_material};
        TINT_CHECKABLE_BUTTON_LIST = new int[]{C0158R.drawable.abc_btn_check_material, C0158R.drawable.abc_btn_radio_material};
    }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (resId == C0158R.drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0158R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0158R.drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId, boolean failIfNotKnown, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable;
        } else if (resId == C0158R.drawable.abc_seekbar_track_material) {
            ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (resId == C0158R.drawable.abc_ratingbar_indicator_material || resId == C0158R.drawable.abc_ratingbar_small_material) {
            ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0158R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int resId, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, resId)) {
            colorAttr = C0158R.attr.colorControlNormal;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, resId)) {
            colorAttr = C0158R.attr.colorControlActivated;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, resId)) {
            colorAttr = 16842801;
            colorAttrSet = true;
            tintMode = Mode.MULTIPLY;
        } else if (resId == C0158R.drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = 16842800;
            colorAttrSet = true;
    ...
    final Mode getTintMode(int resId) {
        if (resId == C0158R.drawable.abc_switch_thumb_material) {
    ...
    public final ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            if (resId == C0158R.drawable.abc_edit_text_material) {
                tint = createEditTextColorStateList(context);
            } else if (resId == C0158R.drawable.abc_switch_track_mtrl_alpha) {
                tint = createSwitchTrackColorStateList(context);
            } else if (resId == C0158R.drawable.abc_switch_thumb_material) {
                tint = createSwitchThumbColorStateList(context);
            } else if (resId == C0158R.drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == C0158R.drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context);
            } else if (resId == C0158R.drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context);
            } else if (resId == C0158R.drawable.abc_spinner_mtrl_am_alpha || resId == C0158R.drawable.abc_spinner_textfield_background_material) {
                tint = createSpinnerColorStateList(context);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                tint = ThemeUtils.getThemeAttrColorStateList(context, C0158R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                tint = createDefaultColorStateList(context);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                tint = createCheckableButtonColorStateList(context);
            } else if (resId == C0158R.drawable.abc_seekbar_thumb_material) {
    ...
    private ColorStateList createDefaultColorStateList(Context context) {
        int colorControlNormal = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlNormal);
        int colorControlActivated = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated);
    ...
    private ColorStateList createCheckableButtonColorStateList(Context context) {
        ...
        colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0158R.attr.colorControlNormal);
        int i = 0 + 1;
        states[i] = ThemeUtils.CHECKED_STATE_SET;
        colors[i] = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated);
        i++;
        states[i] = ThemeUtils.EMPTY_STATE_SET;
        colors[i] = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlNormal);
        i++;
        return new ColorStateList(states, colors);
    }
    ...
    private ColorStateList createSwitchTrackColorStateList(Context context) {
        ...
        int i = 0 + 1;
        states[i] = ThemeUtils.CHECKED_STATE_SET;
        colors[i] = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated, 0.3f);
        i++;
        states[i] = ThemeUtils.EMPTY_STATE_SET;
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        int[] colors = new int[3];
        ColorStateList thumbColor = ThemeUtils.getThemeAttrColorStateList(context, C0158R.attr.colorSwitchThumbNormal);
        int i;
        if (thumbColor == null || !thumbColor.isStateful()) {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0158R.attr.colorSwitchThumbNormal);
            i = 0 + 1;
            states[i] = ThemeUtils.CHECKED_STATE_SET;
            colors[i] = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated);
            i++;
            states[i] = ThemeUtils.EMPTY_STATE_SET;
            colors[i] = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorSwitchThumbNormal);
            i++;
        } else {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
    ...
    private ColorStateList createDefaultButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorAccent));
    }

    private ColorStateList createButtonColorStateList(Context context, @ColorInt int baseColor) {
        states = new int[4][];
        int[] colors = new int[4];
        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlHighlight);
        states[0] = ThemeUtils.DISABLED_STATE_SET;
        colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0158R.attr.colorButtonNormal);
        int i = 0 + 1;
        states[i] = ThemeUtils.PRESSED_STATE_SET;
    ...
    private ColorStateList createSeekbarThumbColorStateList(Context context) {
        states = new int[2][];
        int[] colors = new int[]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.getDisabledThemeAttrColor(context, C0158R.attr.colorControlActivated)};
        int i = 0 + 1;
        states[i] = ThemeUtils.EMPTY_STATE_SET;
        colors[i] = ThemeUtils.getThemeAttrColor(context, C0158R.attr.colorControlActivated);
        i++;
