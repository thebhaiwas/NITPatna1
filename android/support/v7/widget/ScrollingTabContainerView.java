...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            super(context, null, C0158R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{16842964};
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0158R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0158R.attr.actionBarTabTextStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0158R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0158R.attr.actionDropDownStyle);
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility == 0) {
            ...
            ViewPropertyAnimatorCompat anim = ViewCompat.animate(this).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new C01881(tabView);
    ...
    public void addTab(Tab tab, boolean setSelected) {
        ...
        this.mTabLayout.addView(tabView, new LayoutParams(0, -1, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        if (this.mTabSpinner != null) {
    ...
    public void addTab(Tab tab, int position, boolean setSelected) {
        TabView tabView = createTabView(tab, false);
        this.mTabLayout.addView(tabView, position, new LayoutParams(0, -1, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        if (this.mTabSpinner != null) {
            ((TabAdapter) this.mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
        if (setSelected) {
