...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0158R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0158R.styleable.ButtonBarLayout_allowStacking, false);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0158R.id.spacer);
        if (spacer != null) {
