...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latiude, double longitude) {
        ...
        double solarLng = (1.796593063d + (((((double) meanAnomaly) + (0.03341960161924362d * Math.sin((double) meanAnomaly))) + (3.4906598739326E-4d * Math.sin((double) (ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT * meanAnomaly)))) + (5.236000106378924E-6d * Math.sin((double) (3.0f * meanAnomaly))))) + 3.141592653589793d;
