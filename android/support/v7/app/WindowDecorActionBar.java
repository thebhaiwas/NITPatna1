...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C04003 implements ViewPropertyAnimatorUpdateListener {
        C04003() {
        }
    ...
    class C05641 extends ViewPropertyAnimatorListenerAdapter {
        C05641() {
        }
    ...
    class C05652 extends ViewPropertyAnimatorListenerAdapter {
        C05652() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C05641();
        this.mShowListener = new C05652();
        this.mUpdateListener = new C04003();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0158R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0158R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0158R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0158R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0158R.styleable.ActionBar, C0158R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0158R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0158R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ViewCompat.setAlpha(this.mContainerView, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            ViewCompat.setTranslationY(this.mContainerView, 0.0f);
            if (this.mContentAnimations && this.mContentView != null) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0158R.attr.actionBarWidgetTheme, outValue, true);
