...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01531 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall);
            }
    ...
    class C01545 implements Runnable {

        /* renamed from: android.support.v7.app.AppCompatDelegateImplV7.5.1 */
        class C05611 extends ViewPropertyAnimatorListenerAdapter {
            C05611() {
            }

            public void onAnimationEnd(View view) {
                ViewCompat.setAlpha(AppCompatDelegateImplV7.this.mActionModeView, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim = ViewCompat.animate(AppCompatDelegateImplV7.this.mActionModeView).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C05611());
        }
    }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C03981 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C03981() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C03981());
            }
        }
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0158R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0158R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0158R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0158R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0158R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0158R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0158R.layout.abc_list_menu_item_layout);
    ...
    class C03952 implements OnApplyWindowInsetsListener {
        C03952() {
        }
    ...
    class C03963 implements OnFitSystemWindowsListener {
        C03963() {
        }
    ...
    class C03974 implements OnAttachListener {
        C03974() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class C05631 extends ViewPropertyAnimatorListenerAdapter {
            C05631() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C05631());
            }
    ...
    class C05626 extends ViewPropertyAnimatorListenerAdapter {
        C05626() {
        }
    ...
    AppCompatDelegateImplV7(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C01531();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0158R.styleable.AppCompatTheme);
        if (a.hasValue(C0158R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(C0158R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0158R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall);
            }
            if (a.getBoolean(C0158R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0337R.styleable.AppCompatTheme_seekBarStyle);
            }
            if (a.getBoolean(C0158R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0158R.styleable.AppCompatTheme_android_windowIsFloating, false);
            a.recycle();
            LayoutInflater inflater = LayoutInflater.from(this.mContext);
            ViewGroup subDecor = null;
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(C0158R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(C0158R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C03952());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C03963());
                }
            } else if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0158R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context themedContext;
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0158R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    themedContext = this.mContext;
                }
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0158R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0158R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0337R.styleable.AppCompatTheme_seekBarStyle);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0158R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ViewGroup decorContent = (ViewGroup) this.mWindow.findViewById(16908290);
            ContentFrameLayout abcContent = (ContentFrameLayout) subDecor.findViewById(C0158R.id.action_bar_activity_content);
            ...
            abcContent.setAttachListener(new C03974());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0158R.styleable.AppCompatTheme);
        a.getValue(C0158R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0158R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0158R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0158R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0158R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0158R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0158R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0158R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0158R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0158R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0337R.styleable.AppCompatTheme_ratingBarStyleSmall) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case ConnectionResult.DEVELOPER_ERROR /*10*/:
                ...
                return true;
            case C0337R.styleable.AppCompatTheme_ratingBarStyleSmall /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0337R.styleable.AppCompatTheme_seekBarStyle /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0337R.styleable.AppCompatTheme_ratingBarStyleSmall) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0158R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, null, C0158R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0158R.attr.actionBarSize, outValue, true);
                    ...
                    this.mShowActionModePopup = new C01545();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0158R.id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim = ViewCompat.animate(this.mActionModeView).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                    this.mFadeAnim.setListener(new C05626());
                    if (this.mActionModePopup != null) {
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0337R.styleable.AppCompatTheme_ratingBarStyleSmall) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.applyStyle(outValue.resourceId, true);
                widgetTheme.resolveAttribute(C0158R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0158R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0337R.styleable.AppCompatTheme_ratingBarStyleSmall) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0337R.styleable.AppCompatTheme_ratingBarStyleSmall, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0337R.styleable.AppCompatTheme_ratingBarStyleSmall || featureId == 0) && this.mDecorContentParent != null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0158R.color.abc_input_method_navigation_guard));
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0337R.styleable.AppCompatTheme_ratingBarStyleSmall;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0337R.styleable.AppCompatTheme_seekBarStyle;
        }
    }
