...
public class AsyncListUtil<T> {
    ...
    class C04011 implements MainThreadCallback<T> {
        C04011() {
        }
    ...
    class C04022 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C04011();
        this.mBackgroundCallback = new C04022();
        this.mTClass = klass;
