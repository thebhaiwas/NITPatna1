...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C04031 implements MainThreadCallback<T> {
        ...
        class C01601 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C04031.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C04031.UPDATE_ITEM_COUNT /*1*/:
                            C04031.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C04031.ADD_TILE /*2*/:
                            C04031.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C04031.REMOVE_TILE /*3*/:
                            C04031.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C04031.this.mQueue.next();
                }
            }
        }

        C04031(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01601();
        }
    ...
    class C04042 implements BackgroundCallback<T> {
        ...
        class C01611 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C04042.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C04042.REFRESH /*1*/:
                                C04042.this.mQueue.removeMessages(C04042.REFRESH);
                                C04042.this.val$callback.refresh(msg.arg1);
                                break;
                            case C04042.UPDATE_RANGE /*2*/:
                                C04042.this.mQueue.removeMessages(C04042.UPDATE_RANGE);
                                C04042.this.mQueue.removeMessages(C04042.LOAD_TILE);
                                C04042.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C04042.LOAD_TILE /*3*/:
                                C04042.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C04042.RECYCLE_TILE /*4*/:
                                C04042.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C04042.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C04042(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01611();
        }
