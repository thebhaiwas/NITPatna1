...
class AccessibilityManagerCompatIcs {
    ...
    static class C01131 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C01131(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
