...
public class ViewPager extends ViewGroup {
    ...
    static class C01061 implements Comparator<ItemInfo> {
        C01061() {
        }
    ...
    static class C01072 implements Interpolator {
        C01072() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C03881 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03881() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03881());
        }
    ...
    class C03874 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01061();
        sInterpolator = new C01072();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01083();
    ...
    void initViewPager() {
        ...
        this.mCloseEnough = (int) (ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT * density);
        this.mDefaultGutterSize = (int) (16.0f * density);
        ViewCompat.setAccessibilityDelegate(this, new MyAccessibilityDelegate());
        if (ViewCompat.getImportantForAccessibility(this) == 0) {
            ViewCompat.setImportantForAccessibility(this, SCROLL_STATE_DRAGGING);
        }
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03874());
    }
    ...
    private void calculatePageOffsets(ItemInfo curItem, int curIndex, ItemInfo oldCurInfo) {
        ...
        this.mLastOffset = curItem.position == N + INVALID_POINTER ? (curItem.offset + curItem.widthFactor) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : AutoScrollHelper.NO_MAX;
                ...
                switch (action & MotionEventCompat.ACTION_MASK) {
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(ImageRequest.DEFAULT_IMAGE_TIMEOUT_MS, (float) this.mMaximumVelocity);
