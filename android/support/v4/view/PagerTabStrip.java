...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    class C01022 implements OnClickListener {
        C01022() {
        }
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mPrevText.setOnClickListener(new C01011());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C01022());
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        this.mTabAlpha = (int) ((Math.abs(positionOffset - 0.5f) * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) * 255.0f);
