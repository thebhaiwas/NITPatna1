...
class TextToSpeechICSMR1 {
    ...
    static class C00941 extends UtteranceProgressListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00941(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
    ...
    static class C00952 implements OnUtteranceCompletedListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        C00952(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
            this.val$listener = utteranceProgressListenerICSMR1;
        }
    ...
    static void setUtteranceProgressListener(TextToSpeech tts, UtteranceProgressListenerICSMR1 listener) {
        if (VERSION.SDK_INT >= 15) {
            tts.setOnUtteranceProgressListener(new C00941(listener));
        } else {
            tts.setOnUtteranceCompletedListener(new C00952(listener));
        }
    }
}
