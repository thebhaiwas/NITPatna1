...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00801 implements Creator<QueueItem> {
            C00801() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00811 implements Creator<ResultReceiverWrapper> {
            C00811() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00821 implements Creator<Token> {
            C00821() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0337R.styleable.AppCompatTheme_panelMenuListWidth /*79*/:
                        case C0337R.styleable.AppCompatTheme_colorControlNormal /*85*/:
                            boolean isPlaying;
                        ...
                        case C0337R.styleable.AppCompatTheme_colorControlHighlight /*87*/:
                        ...
                        case C0337R.styleable.AppCompatTheme_colorSwitchThumbNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                            }
        ...
        class C03801 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C03801() {
            }
        ...
        class C05602 implements Callback {
            C05602() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C03801();
