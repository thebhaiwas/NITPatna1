...
public final class RatingCompat implements Parcelable {
    ...
    static class C00691 implements Creator<RatingCompat> {
        C00691() {
        }
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(RATING_HEART, hasHeart ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(RATING_THUMB_UP_DOWN, thumbIsUp ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == RATING_THUMB_UP_DOWN && this.mRatingValue == DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) {
            return true;
        }
        return false;
    }
