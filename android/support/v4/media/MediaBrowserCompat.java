...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        static class C00571 implements Creator<MediaItem> {
            C00571() {
            }
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal {
        ...
        class C00491 implements Runnable {
            ...
            C00491(ItemCallback itemCallback, String str) {
        ...
        class C00502 implements Runnable {
            ...
            C00502(ItemCallback itemCallback) {
                this.val$cb = itemCallback;
            }
        ...
        class C00513 implements Runnable {
            ...
            C00513(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                this.mHandler.post(new C00491(cb, mediaId));
            } else if (this.mServiceBinderWrapper == null) {
                this.mHandler.post(new C00502(cb));
            } else {
                try {
                    ...
                    this.mHandler.post(new C00513(cb, mediaId));
                }
            }
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        class C00521 implements Runnable {
            ...
            C00521(ServiceConnection serviceConnection) {
        ...
        class C00532 implements Runnable {
            ...
            C00532(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        class C00543 implements Runnable {
            ...
            C00543(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            class C00551 implements Runnable {
                ...
                C00551(ComponentName componentName, IBinder iBinder) {
            ...
            class C00562 implements Runnable {
                final /* synthetic */ ComponentName val$name;

                C00562(ComponentName componentName) {
                    this.val$name = componentName;
                }
            ...
            public void onServiceConnected(ComponentName name, IBinder binder) {
                postOrRun(new C00551(name, binder));
            }

            public void onServiceDisconnected(ComponentName name) {
                postOrRun(new C00562(name));
            }
        ...
        public void connect() {
            if (this.mState != 0) {
                ...
                if (!bound) {
                    this.mHandler.post(new C00521(thisConnection));
                }
            }
        }
        ...
        public void unsubscribe(@NonNull String parentId, Bundle options) {
            ...
            Subscription sub = (Subscription) this.mSubscriptions.get(parentId);
            if (sub != null && sub.remove(options) && this.mState == CONNECT_STATE_CONNECTED) {
                try {
                    this.mServiceBinderWrapper.removeSubscription(parentId, options, this.mCallbacksMessenger);
                } catch (RemoteException e) {
                    Log.d(MediaBrowserCompat.TAG, "removeSubscription failed with RemoteException parentId=" + parentId);
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                Log.i(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
                this.mHandler.post(new C00532(cb, mediaId));
            } else {
                try {
                    this.mServiceBinderWrapper.getMediaItem(mediaId, new ItemReceiver(mediaId, cb, this.mHandler));
                } catch (RemoteException e) {
                    Log.i(MediaBrowserCompat.TAG, "Remote error getting media item.");
                    this.mHandler.post(new C00543(cb, mediaId));
                }
            }
        }
