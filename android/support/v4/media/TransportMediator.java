...
public class TransportMediator extends TransportController {
    ...
    class C00702 implements Callback {
        C00702() {
        }
    ...
    class C03781 implements TransportMediatorCallback {
        C03781() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C03781();
        this.mKeyEventCallback = new C00702();
