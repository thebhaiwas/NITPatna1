...
class TransportMediatorJellybeanMR2 {
    ...
    class C00711 implements OnWindowAttachListener {
        C00711() {
        }
    ...
    class C00722 implements OnWindowFocusChangeListener {
        C00722() {
        }
    ...
    class C00744 implements OnAudioFocusChangeListener {
        C00744() {
        }
    ...
    class C00755 implements OnGetPlaybackPositionListener {
        C00755() {
        }
    ...
    class C00766 implements OnPlaybackPositionUpdateListener {
        C00766() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00711();
        this.mWindowFocusListener = new C00722();
        this.mMediaButtonReceiver = new C00733();
        this.mAudioFocusChangeListener = new C00744();
        this.mGetPlaybackPositionListener = new C00755();
        this.mPlaybackPositionUpdateListener = new C00766();
        this.mPlayState = 0;
