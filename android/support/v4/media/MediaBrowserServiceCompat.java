...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceImpl {
        ...
        class C00667 implements Runnable {
            ...
            C00667(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00667(callbacks));
        }
    }

    /* renamed from: android.support.v4.media.MediaBrowserServiceCompat.3 */
    class C03743 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C03743(Object x0, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C03754 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C03754(Object x0, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(x0);
        }
    ...
    private class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class C03761 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            C03761(Handler x0, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String mediaId, ItemCallback cb) {
            this.mServiceImpl.getMediaItem(mediaId, new C03761(MediaBrowserServiceCompat.this.mHandler, cb));
        }
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C03743(parentId, connection, parentId, options);
        if (options == null) {
            onLoadChildren(parentId, result);
        } else {
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C03754(itemId, receiver);
