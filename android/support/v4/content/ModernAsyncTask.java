...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00431 implements ThreadFactory {
    ...
    class C00443 extends FutureTask<Result> {
        C00443(Callable x0) {
            super(x0);
        }
    ...
    class C03722 extends WorkerRunnable<Params, Result> {
        C03722() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C03722();
        this.mFuture = new C00443(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00454.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
