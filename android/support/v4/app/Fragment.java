...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C00301 implements Creator<SavedState> {
            C00301() {
            }
    ...
    class C03681 extends FragmentContainer {
        C03681() {
        }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C03681(), this);
    }
