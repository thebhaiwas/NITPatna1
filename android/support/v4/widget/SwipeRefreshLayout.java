...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01342 extends Animation {
        C01342() {
        }
    ...
    class C01353 extends Animation {
        C01353() {
        }
    ...
    class C01364 extends Animation {
    ...
    class C01375 implements AnimationListener {
        C01375() {
        }
    ...
    class C01386 extends Animation {
        C01386() {
        }
    ...
    class C01397 extends Animation {
        C01397() {
        }
    ...
    class C01408 extends Animation {
        C01408() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01331();
        this.mAnimateToCorrectPosition = new C01386();
        this.mAnimateToStartPosition = new C01397();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01342();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01353();
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new C01364(startingAlpha, endingAlpha);
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01408();
