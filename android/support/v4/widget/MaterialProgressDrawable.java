...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C01251 extends Animation {
    ...
    class C01262 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
        ...
        public void onAnimationRepeat(Animation animation) {
            ...
            MaterialProgressDrawable.this.mRotationCount = (MaterialProgressDrawable.this.mRotationCount + DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) % MaterialProgressDrawable.NUM_POINTS;
        }
    }

    /* renamed from: android.support.v4.widget.MaterialProgressDrawable.3 */
    class C01273 implements Callback {
        C01273() {
        }
    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                this.mArrow.lineTo((((float) this.mArrowWidth) * this.mArrowScale) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, ((float) this.mArrowHeight) * this.mArrowScale);
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= 0.0d || minEdge < 0.0f) {
                insets = (float) Math.ceil((double) (this.mStrokeWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT));
            } else {
                insets = (float) (((double) (minEdge / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) - this.mRingCenterRadius);
            }
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        return ((((((int) (((float) (((endInt >> 24) & MotionEventCompat.ACTION_MASK) - startA)) * fraction)) + startA) << 24) | ((((int) (((float) (((endInt >> 16) & MotionEventCompat.ACTION_MASK) - startR)) * fraction)) + startR) << 16)) | ((((int) (((float) (((endInt >> 8) & MotionEventCompat.ACTION_MASK) - startG)) * fraction)) + startG) << 8)) | (((int) (((float) ((endInt & MotionEventCompat.ACTION_MASK) - startB)) * fraction)) + startB);
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C01251(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C01262(ring));
