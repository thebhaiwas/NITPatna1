...
public class ViewDragHelper {
    ...
    static class C01411 implements Interpolator {
        C01411() {
        }
    ...
    class C01422 implements Runnable {
        C01422() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        this.mSetIdleRunnable = new C01422();
        if (forParent == null) {
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(ImageRequest.DEFAULT_IMAGE_TIMEOUT_MS, this.mMaxVelocity);
