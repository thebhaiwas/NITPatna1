...
class CircularBorderDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float halfBorderWidth = this.mPaint.getStrokeWidth() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
