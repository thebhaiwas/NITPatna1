...
class ValueAnimatorCompat {
    ...
    class C03641 implements AnimatorUpdateListenerProxy {
        final /* synthetic */ AnimatorUpdateListener val$updateListener;

        C03641(AnimatorUpdateListener animatorUpdateListener) {
    ...
    class C03652 implements AnimatorListenerProxy {
        final /* synthetic */ AnimatorListener val$listener;

        C03652(AnimatorListener animatorListener) {
    ...
    public void setUpdateListener(AnimatorUpdateListener updateListener) {
        if (updateListener != null) {
            this.mImpl.setUpdateListener(new C03641(updateListener));
        } else {
    ...
    public void setListener(AnimatorListener listener) {
        if (listener != null) {
            this.mImpl.setListener(new C03652(listener));
        } else {
