...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00041 implements Comparator<View> {
        C00041() {
        }
    ...
    protected static class SavedState extends BaseSavedState {
        ...
        static class C03491 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03491() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03491());
        }
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mLayoutDependencyComparator = new C00041();
