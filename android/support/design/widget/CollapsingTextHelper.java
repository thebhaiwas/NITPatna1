...
final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets() {
        ...
        switch (collapsedAbsGravity & 112) {
            ...
            case C0337R.styleable.AppCompatTheme_panelMenuListTheme /*80*/:
                ...
                break;
            default:
                this.mCollapsedDrawY = ((float) this.mCollapsedBounds.centerY()) + (((this.mTextPaint.descent() - this.mTextPaint.ascent()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - this.mTextPaint.descent());
                break;
        }
        switch (collapsedAbsGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) {
            case ConnectionResult.SERVICE_MISSING /*1*/:
                this.mCollapsedDrawX = ((float) this.mCollapsedBounds.centerX()) - (width / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
                break;
        ...
        switch (expandedAbsGravity & 112) {
            ...
            case C0337R.styleable.AppCompatTheme_panelMenuListTheme /*80*/:
                ...
                break;
            default:
                this.mExpandedDrawY = ((float) this.mExpandedBounds.centerY()) + (((this.mTextPaint.descent() - this.mTextPaint.ascent()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - this.mTextPaint.descent());
                break;
        }
        switch (expandedAbsGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) {
            case ConnectionResult.SERVICE_MISSING /*1*/:
                this.mExpandedDrawX = ((float) this.mExpandedBounds.centerX()) - (width / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
                break;
            case ConnectionResult.INVALID_ACCOUNT /*5*/:
    ...
    private void setInterpolatedTextSize(float textSize) {
        ...
        boolean z = USE_SCALING_TEXTURE && this.mScale != DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
        this.mUseTexture = z;
        if (this.mUseTexture) {
