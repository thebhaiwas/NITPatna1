...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    class C03501 implements InternalVisibilityChangedListener {
        final /* synthetic */ OnVisibilityChangedListener val$listener;

        C03501(OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        class C03511 implements AnimatorUpdateListener {
            final /* synthetic */ FloatingActionButton val$fab;

            C03511(FloatingActionButton floatingActionButton) {
            ...
            if (this.mFabTranslationY != targetTransY) {
                ...
                if (!fab.isShown() || Math.abs(currentTransY - targetTransY) <= ((float) fab.getHeight()) * 0.667f) {
                    ...
                    if (this.mFabTranslationYAnimator == null) {
                        ...
                        this.mFabTranslationYAnimator.setUpdateListener(new C03511(fab));
                    }
    ...
    private class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public float getRadius() {
            return ((float) FloatingActionButton.this.getSizeDimension()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
        }
