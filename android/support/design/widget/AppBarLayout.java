...
public class AppBarLayout extends LinearLayout {
    ...
    class C03421 implements OnApplyWindowInsetsListener {
        C03421() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends BaseSavedState {
            ...
            static class C03441 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C03441() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C03441());
            }
        }

        /* renamed from: android.support.design.widget.AppBarLayout.Behavior.1 */
        class C03431 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C03431(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset) {
            ...
            if (currentOffset != offset) {
                if (this.mAnimator == null) {
                    ...
                    this.mAnimator.setUpdateListener(new C03431(coordinatorLayout, child));
                } else {
                    this.mAnimator.cancel();
                }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        float getOverlapRatioForOffset(View header) {
            ...
            if (availScrollRange != 0) {
                return DefaultRetryPolicy.DEFAULT_BACKOFF_MULT + (((float) offset) / ((float) availScrollRange));
            }
            return 0.0f;
        }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03421());
    }
    ...
    final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        return childCount >= PENDING_ACTION_EXPANDED ? (ViewCompat.getMinimumHeight(getChildAt(childCount + INVALID_SCROLL_RANGE)) * PENDING_ACTION_COLLAPSED) + topInset : 0;
    }
