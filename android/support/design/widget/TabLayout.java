...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C03621 implements AnimatorUpdateListener {
            ...
            C03621(int i, int i2, int i3, int i4) {
        ...
        class C05572 extends AnimatorListenerAdapter {
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            this.mIndicatorAnimator.cancel();
            animateIndicatorToPosition(this.mSelectedPosition, Math.round((DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.mIndicatorAnimator.getAnimatedFraction()) * ((float) this.mIndicatorAnimator.getDuration())));
        }
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setUpdateListener(new C03621(startLeft, targetLeft, startRight, targetRight));
                animator.setListener(new C05572(position));
                animator.start();
            }
        }
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (maxWidth <= 0 || (specWidthMode != 0 && specWidthSize <= maxWidth)) {
                ...
                widthMeasureSpec = MeasureSpec.makeMeasureSpec(TabLayout.this.mTabMaxWidth, LinearLayoutManager.INVALID_OFFSET);
            }
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            if (this.mTextView != null) {
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C03611());
                }
