        ...
        if (childLpHeight == -1 || childLpHeight == -2) {
            ...
            if (header != null) {
                ...
                if (ViewCompat.isLaidOut(header)) {
                    ...
                    parent.onMeasureChild(child, parentWidthMeasureSpec, widthUsed, MeasureSpec.makeMeasureSpec((availableHeight - header.getMeasuredHeight()) + getScrollRange(header), childLpHeight == -1 ? 1073741824 : LinearLayoutManager.INVALID_OFFSET), heightUsed);
                    return true;
                }
            }
        }
