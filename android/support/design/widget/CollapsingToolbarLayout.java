...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C03471 implements OnApplyWindowInsetsListener {
        C03471() {
        }
    ...
    class C03482 implements AnimatorUpdateListener {
        C03482() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03471());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C03482());
